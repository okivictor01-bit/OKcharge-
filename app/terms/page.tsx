  ...
  return (
    <main style={{ padding: '40px 20px', maxWidth: '800px', margin: '0 auto', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ backgroundColor: 'white', padding: '30px', borderRadius: '12px', border: '1px solid #e2e8f0', marginBottom: '20px' }}>
        ...
        <p style={{ fontSize: '16px', color: '#475569', lineHeight: '1.6' }}>Power banks must be returned to the designated location. Failure to return the power bank within 7 days will be considered theft, and you will be charged the full replacement cost (₦15,000).</p>
      </div>
      <div style={{ backgroundColor: 'white', padding: '30px', borderRadius: '12px', border: '1px solid #e2e8f0', marginBottom: '20px' }}>
      ...
      <div style={{ backgroundColor: 'white', padding: '30px', borderRadius: '12px', border: '1px solid #e2e8f0', marginBottom: '20px' }}>
        ...
        <ul style={{ fontSize: '16px', color: '#475569', lineHeight: '1.8', paddingLeft: '20px' }}><li>Provide accurate contact information</li><li>Maintain the security of your rental ticket code</li><li>Return the power bank in the condition it was received</li><li>Report any defects or issues immediately</li><li>Be at least 18 years old to rent</li></ul>
      </div>
      <div style={{ backgroundColor: 'white', padding: '30px', borderRadius: '12px', border: '1px solid #e2e8f0', marginBottom: '20px' }}>
        <h2 style={{ fontSize: '24px', color: '#0f172a', marginBottom: '15px' }}>5. Limitation of Liability</h2>
        <p style={{ fontSize: '16px', color: '#475569', lineHeight: '1.6', marginBottom: '15px' }}>OKcharge shall not be liable for:</p>
        <ul style={{ fontSize: '16px', color: '#475569', lineHeight: '1.8', paddingLeft: '20px' }}><li>Damage to your device while charging</li><li>Loss of data or information</li><li>Service interruptions or unavailability</li><li>Indirect, incidental, or consequential damages</li></ul>
      </div>
      <div style={{ backgroundColor: 'white', padding: '30px', borderRadius: '12px', border: '1px solid #e2e8f0', marginBottom: '20px' }}>
        <h2 style={{ fontSize: '24px', color: '#0f172a', marginBottom: '15px' }}>6. Termination</h2>
      ...
      <div style={{ backgroundColor: 'white', padding: '30px', borderRadius: '12px', border: '1px solid #e2e8f0', marginBottom: '20px' }}>
        <h2 style={{ fontSize: '24px', color: '#0f172a', marginBottom: '15px' }}>7. Changes to Terms</h2>
      ...
      <div style={{ backgroundColor: 'white', padding: '30px', borderRadius: '12px', border: '1px solid #e2e8f0', marginBottom: '20px' }}>
        <h2 style={{ fontSize: '24px', color: '#0f172a', marginBottom: '15px' }}>8. Governing Law</h2>
