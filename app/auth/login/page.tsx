  ...
  return (
    <main style={{ padding: '40px 20px', fontFamily: 'sans-serif', maxWidth: '400px', margin: '0 auto', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', marginBottom: '30px' }}>
        ...
        <h1 style={{ fontSize: '24px', color: '#0f172a', marginBottom: '10px' }}>Partner Login</h1>
        <p style={{ color: '#64748b', fontSize: '14px' }}>Sign in to access your owner dashboard</p>
      </div>
      ...
      <form onSubmit={handleLogin}>
        ...
        <input
          style={inputStyle}
          type="email"
          placeholder="partner@okcharge.ng"
          value={email}
