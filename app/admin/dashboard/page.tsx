  ...
  return (
    <main style={{ padding: '20px', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '25px' }}>
        ...
        <a href="/admin/staff" style={navButtonStyle}>
           👥 Manage Staff <span style={{ float: 'right', color: '#64748b', fontWeight: 'normal' }}>→</span>
        </a>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', height: '150px', gap: '10px' }}>
          {chartData.map((data, idx) => (
            <div key={idx} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100%' }}>
              ...
              <div style={{ width: '100%', maxWidth: '40px', backgroundColor: '#3b82f6', borderRadius: '4px 4px 0 0', height: `${Math.max((data.revenue / maxChartRevenue) * 100, 2)}%`, transition: 'height 0.5s ease' }}></div>
